describe("Envio de SMS via API", () => {
  it("Deve enviar o SMS com sucesso", () => {
      ...
      messages: [
        {
          ...
          message: "Envio Validação Cypress",
    ...
    cy.request({
      ...
      headers: {
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJleHAiOjE3NDUwMDE0NDIsInVzZXJfaWQiOjE4MzQ1LCJjdXN0b21lcl9pZCI6MTYyNCwiYXVkIjoiYXBpIiwidWlkIjoiNzEyMDZkNjQtNTIxYS00NzI2LTg3YjAtMDY3MzhhNmUzODUzIn0.78q7_I2WtdpGwPBJQuNtVaBE790j0-Dn1HjJpgEem9c",
